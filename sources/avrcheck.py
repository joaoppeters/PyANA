...
def generate_line_range_hash(
    filepath: Path, start_line: int, end_line: int, hash_algorithm: str = "sha256"
) -> str:
    """
...
def check_line_range_differences(
    ...
    print(
        f"Encontrados {len(file_paths)} arquivos. Processando o conteúdo das Linhas {start} a {end}..."
    )
