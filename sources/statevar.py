...
class StateVar:
    ...
    def stateVT(
        ...
        self.thetaref = powerflow.solution['theta'][
            powerflow.setup.dbarraDF.loc[powerflow.setup.dbarraDF['tipo'] == 2].index[0]
        ]
        ...
        ax.plot(
            ...
            powerflow.setup.options['vmax'] * ones(360),
            linestyle="--",
        ...
        ax.plot(
            ...
            powerflow.setup.options['vmin'] * ones(360),
            linestyle="--",
            color=(1.0, 0.8, 0.7961),
            alpha=1.0,
            zorder=2,
        ...
        for theta, rotation, label in zip(
            ...
            powerflow.setup.dbarraDF['nome'].values,
        ):
            ax.text(
                theta,
                ax.get_ylim()[1] + 0.075,
        ...
        ax.legend(
            bars,
            powerflow.setup.dbarraDF['nome'].values.tolist(),
            frameon=False,
            loc="upper center",
        ...
        # Save
        fig.savefig(
            powerflow.setup.dirRstatevar + powerflow.setup.name + "-stateVT.png",
            dpi=400,
        )
