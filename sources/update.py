...
def updttm(
    ...
    powerflow.solution["theta"] += powerflow.timestatevar[3*powerflow.nger:3*powerflow.nger+powerflow.nbus]
    powerflow.solution["voltage"] += powerflow.timestatevar[4*powerflow.nger+powerflow.nbus:]